            ...
            <div class="gioithieu">
                ...
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row g-0">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                <p class="card-text">Với phương châm "Vẻ đẹp bắt đầu từ bên trong," chúng tôi cung cấp
                                    cả các sản phẩm chăm sóc da tự nhiên và hữu cơ để bạn có thể nuôi dưỡng làn da của
                                    mình bằng cách an toàn và lành tính. Chúng tôi coi trọng tình cảm của khách hàng và
                                    luôn lắng nghe ý kiến và phản hồi để phục vụ bạn tốt hơn.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row g-0">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                <p class="card-text">Đội ngũ nhân viên tận tâm của chúng tôi sẽ hỗ trợ bạn trong việc
                                    lựa chọn sản phẩm phù hợp nhất với nhu cầu và mong muốn cá nhân của bạn. Chúng tôi
                                    không chỉ cung cấp các sản phẩm mỹ phẩm tốt nhất, mà còn mang đến cho bạn kiến thức
                                    và sự tư vấn chuyên nghiệp để bạn có thể tận dụng tối đa sản phẩm mà bạn chọn.</p>
                            </div>
                        </div>
                    </div>
                </div>
