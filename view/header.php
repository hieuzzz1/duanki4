    ...
    <section class="myheader">
        <div class="container py-3">
            <div class="row">
                <!-- logo -->
                <div class="col-md-2">
                    <a href="index.php"><img src="./img/logo/logo_duan1HT.png" style="max-width: 100%; height: 65px;" class="img-fluid"
                        alt=""></a>
                </div>
                <!-- search -->
                <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="row pe-6">
                                ...
                                <div class="col-10">
                                    Xin chào!<br> <a href="indextk.php?act=dangnhap" class="text-decoration-none"><strong class="text-danger fs-6">Đăng nhập</strong></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid">
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0 cangiua">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-white px-4" href="index.php?act=gioithieu">Giới thiệu</a>
                                </li>
